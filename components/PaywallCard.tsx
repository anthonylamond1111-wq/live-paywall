...
export default function PaywallCard({ email, message, busy, onCheckout }: PaywallCardProps) {
  return (
    <div className="mx-auto max-w-md rounded-2xl border border-red-600/50 bg-zinc-900/90 p-6 text-center shadow-[0_0_60px_rgba(220,38,38,0.08)] sm:rounded-3xl sm:p-10">
      ...
      <p className="mb-6 text-sm text-gray-400 sm:mb-8 sm:text-base">
        One-time payment for full access tonight. Your purchase stays on your account.
      </p>
      ...
      <div className="flex items-center justify-center gap-3 text-[10px] uppercase tracking-wider text-gray-500">
        <span>Stripe</span>
      ...
      <p className="mt-3 text-xs text-gray-600">Secure checkout • Instant access</p>
    </div>
  );
}
